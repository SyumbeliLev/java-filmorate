...
import ru.filmorate.storage.InMemoryFilmStorage;
...
public class FilmServiceImplTest {
    ...
    public void create() {
        ...
        film6 = Film.builder()
                ...
                .releaseDate(LocalDate.of(1895, 12, 30))
                .duration(100)
                .likes(Set.of(1L, 2L, 3L, 4L, 5L, 6L))
                .build();
        film7 = Film.builder()
                .name("name")
                .description("DESCRIPTION")
                .releaseDate(LocalDate.of(1895, 12, 30))
                .duration(100)
                .likes(Set.of(1L, 2L, 3L, 4L, 5L, 6L, 7L))
                .build();
        film8 = Film.builder()
                .name("name")
                .description("DESCRIPTION")
                .releaseDate(LocalDate.of(1895, 12, 30))
                .duration(100)
                .likes(Set.of(1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L))
                .build();
        film9 = Film.builder()
                .name("name")
                .description("DESCRIPTION")
                .releaseDate(LocalDate.of(1895, 12, 30))
                .duration(100)
                .likes(Set.of(1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L))
                .build();
        film10 = Film.builder()
                .name("name")
                .description("DESCRIPTION")
                .releaseDate(LocalDate.of(1895, 12, 30))
                .duration(100)
                .likes(Set.of(1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L))
                .build();
    ...
    public void addLikeTest() {
        ...
        service.addLike(1, 1);
        assertEquals(1, filmEmptyLike.getLikes()
                .size());
    }
    ...
    public void removeLikeTest() {
        ...
        assertEquals(0, filmEmptyLike.getLikes()
                .size());
    }
